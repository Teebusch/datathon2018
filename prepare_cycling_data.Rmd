...
## Clean longitude and latitude format
...
df <- df %>% 
  mutate(
    ...
    time = ifelse(day == ymd("2017-10-17"), 
                  with_tz(day, "Europe/Brussels"), 
                  with_tz(day, "Europe/Athens")),
  ...
  select(qid, id, day, dayid, ts, time, everything(), 
